...
/*  У вас есть 24 собаки и 8 котов. Порция обеда для каждого животного составляет 50 грамм и стоит 2 доллара.
  Животные кушают 3 раза в день.
...
public class AnimalHouse {
        ...
        public AnimalHouse(int dogsNumber, int catsNumber) {
        ...
        public static void main(String[] args) {
            AnimalHouse FirstShelter = new AnimalHouse(24, 8);
