...
public class Students {
    ...
    private final String[] ADDRESSES = {"г. Гомель, ул. Советская д. 1 кв. 10",
            "г. Минск, ул Мельникайте д. 12 кв. 45", "г. Витебск, п-т Ленина д. 34 кв. 18",
            "г. Гродно, ул. Макарова д. 16", "г. Брест, ул. Советская д. 16 кв. 54",
            "г. Могилев, ул. 50-лет БССР д. 17 кв. 123"};
    public static final String[] FACULTIES = {"Физический", "Математический", "Химико-биологический", "Филологический",
            "Экономический", "Факультет иностранных языков", "Факультет физической культуры и спорта"};
